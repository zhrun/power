 ...
 * @LastEditTime: 2019-10-08 17:20:48
    ...
    <div class="common_content">
      ...
      <div class="boxBoder">
         <el-input placeholder="角色名称" v-model="keyword" class="input-with-select" style="width:400px;">
          ...
          <el-button type="primary" @click="addVersion" style="margin-left:20px;" >添加角色</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    seeRole(item){
      this.$router.push({name:'seerole', params: { uid: item.uid,name:item.roleName,desc:item.roleDesc }})
    },
    controlRole(item){
      this.$router.push({name:'groundrole', params: { uid: item.uid,name:item.roleName,desc:item.roleDesc  }})
    },
