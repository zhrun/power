/*
 * @Author: zhou.run 
 * @Date: 2020-07-07 10:51:51 
 * @Last Modified by: zhou.run
 * @Last Modified time: 2020-07-24 14:34:03
 */
<template>
  <div class="program-up">
        ...
        <div class="boxBoder">
          <el-form :inline="true" :model="formInline" ref="ruleForm" class="demo-form-inline" @submit.native.prevent>
            <el-form-item label="搜索" prop="keyword">
              <el-input  v-model="formInline.keyword" placeholder="职务名称"  @keyup.enter.native="onSubmit"  ></el-input>
            </el-form-item>
            <el-form-item>
          ...
          >
            ...
            <el-table-column label="操作" width="150px">
              <template slot-scope="scope">
                ...
                <span class="disable"  @click="noClick"  alt="系统默认禁止操作" v-else>删除</span>
              </template>
            </el-table-column>
          </el-table>
          <el-pagination
    ...
    <el-dialog
      ...
      <el-form :model="addFormData" ref="addForm" :rules="addRules" label-width="120px">
        <el-form-item label="职务名称" prop="postName">
          <el-input maxlength="10" v-model="addFormData.postName" placeholder="请输入职务名称"></el-input>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form :model="addFormData" ref="addForm" :rules="addRules" label-width="120px">
        <el-form-item label="职务名称" prop="postName">
          <el-input maxlength="11" v-model="addFormData.postName" placeholder="请输入职务名称"></el-input>
        </el-form-item>
        <el-form-item label="位次" prop="position">
          <el-input v-model="addFormData.position"  :maxlength="6" placeholder="请输入位次"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 面包屑导航数据
      breadcrumbData: [{ name: "系统设置" }, { name: "职务管理" }],
      formInline: {
        date: null,
        opUserId: "",
        pageNum: 1,
