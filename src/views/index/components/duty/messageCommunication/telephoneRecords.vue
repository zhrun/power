    ...
    <div class="common_content">
      <el-scrollbar style="height:100%;">
        <el-form :inline="true" style="position:relative;">
          ...
          <el-form-item>
            <el-input type="text" v-model="queryStr" placeholder="联系电话、内容" style="width:320px;"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <div class="common_table">
          <el-table :data="dutyPageList" tooltip-effect="dark" style="width: 100%" v-loading="tableLoading">
            <el-table-column label="来电时间" prop="happenTime" width="170"></el-table-column>
            <el-table-column label="内容摘要" prop="summary" show-overflow-tooltip></el-table-column>
            <el-table-column label="联系电话" prop="contactPhone" width="180"></el-table-column>
            <el-table-column label="记录人" prop="recorder" width="180"></el-table-column>
...
export default {
  ...
  data() {
    return {
      breadcrumbData: [{ name: "文电拟办" }, { name: "电话记录" }],
      commonData:[],
      queryStr:null,
      dutyPageList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    //增加
    addCommunication(){
      this.$router.push({ name: "newTelephoneRecord", query:{fromTxt:"add"} })
    },
    //预览
    preInfo(obj){
    ...
    //编辑
    edit(obj){
      this.$router.push({ name: "newTelephoneRecord", query:{fromTxt:"edit", uid:obj.uid} })
    },
    //删除
    del(obj){
      let that = this      
