      ...
      <el-scrollbar style="height:100%;">
        ...
        <div class="common_table">
          <el-table :data="dutyPageList" tooltip-effect="dark" style="width: 100%" v-loading="tableLoading">
            ...
            <el-table-column label="来电时间" prop="happenTime" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  data() {
    return {
      breadcrumbData: [{ name: "文电拟办" }, { name: "来电拟办" }],
      commonData:[],
      queryStr:null,
      dutyPageList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    //增加
    addCommunication(){
      this.$router.push({ name: "calCommunication", query:{fromTxt:"add"} });
    },
    //预览
    preInfo(obj){
    ...
    //编辑
    edit(obj){
      this.$router.push({ name: "calCommunication", query:{fromTxt:"edit", uid:obj.uid} });
    },
    //删除
    del(obj){
      let that = this      
