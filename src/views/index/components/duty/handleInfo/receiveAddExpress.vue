...
import { querySortList, getGenerateNo, postSaveIssueInstruction, putIssueInstructionIssue, putSaveIssueInstruction } from "@/views/index/api/onDuty/api.ps.js";
export default {
  components: { visBreadcrumb },
  data() {
    return {
      breadcrumbData: [{ name: "信息处理" },{ name: "接报值班信息", routerName: "receiveDutyInformation"}, { name: "新增批示下发" }],
      instructeInfo:{
        code: "0", 
        releaseTime : "", 
        title: "",
