 ...
 * @Last Modified time: 2020-09-08 17:05:49
 */
<template>
  <div class="editduty">
    ...
    <div class="main">
      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label=" ">
         <div class="messages" v-if="faildInfo">
           <!-- <div v-if="!faildInfo">
            <p>模板规则</p>
            <p>1、红色为必填项</p>
...
import { importSupplierList} from "@/views/index/api/supplies/api.zr.js";
...
export default {
  ...
  data() {
    return {
      breadcrumbData:[{name: "基础信息"}, {name: "供应商管理",routerName:'supplierManage'},{name:'导入'}],
      ruleForm: {
        pass: '',
        checkPass: '',
        age: ''
      },
      downFile:ajaxCtx.rel+'/duty/work-schedule-service/download',
      fileList:[],
      upLoadSuccess:false,
      fileLoading:false,
      successInfo:{},
  ...
  methods: {
    ...
    uploadAvatarFile(item) {
      ...
      importSupplierList(formData).then(res => {
    ...
    //下载模板
    setDown(){
      let exportUrl = ajaxCtx.rel+'/muem/resource/supplier-service/import-model'
      exportFn(exportUrl,null,'供应商数据模板','xls')
